...
var tours = {
  1:{
    title: "Chinese New Year Celebration", image: 'img_1g.jpg', desc: 'Chinese festival that celebrates the beginning of a new year on the traditional Chinese calendar.', url: 'http://www.kikia.co'
  },
  2:{
    title: "Art & Craft", image: 'img_2g.jpg', desc: 'To provides immediate and lasting cognitive benefits but also creates a unique bonding experience', url: 'http://www.kikia.co'
  },
  3:{
    title: "Cooking Time", image: 'img_3g.jpg', desc: 'Experience of creating meals to  build children self-confidence and lay the foundation for healthy eating habits.', url: 'http://www.kikia.co'
  },
  4:{
    title: "Water Play", image: 'img_4g.jpg', desc: 'Water play is a fun way of learning for young children; as it expand their imagination, physical development, encourages problem solving, numeracy and language.', url: 'http://www.kikia.co'
  },
  5:{
    title: "Children Day", image: 'img_5g.jpg', desc: 'For every child, every right. ', url: 'http://www.kikia.co'
  },
  6:{
    title: "Concert", image: 'img_6g.jpg', desc: 'End of Year Graduation and Annual Ceremony', url: 'http://www.kikia.co'
  }
}
